...
const SingleSkill = ({text, svgImg}) => {
    ...
    return (
       <div className='hover:-translate-y-24 min-h-[300px] ml-2  transition-all relative duration-1000 '>
      ...
      <div className='w-[100px] h-[200px]  bg-gradient-to-r opacity-70 absolute from-orange-700 to-gray-600 a top-[50px] rounded-2xl -z-20'></div>
       </div>
    );
};
